...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-5 col-md-5"  style="margin-top: 80px;">
         ...
         <span><h4 class="product-font">Product Name:</h4></span>
            <input  type="text" class="form-control product-font" style="width:300px" placeholder="Product Name"><br>

            <span><h4 class="product-font">Product Description:</h4></span>
            <input  type="text" class="form-control product-font" style="width:300px" placeholder="Short Description..."><br>

            <textarea style="width: 350px" rows="6" class="form-control  product-font" placeholder="Long Description..."></textarea><br>

            <span><h4 class="product-font">Product Price:</h4></span>
            <input  type="text" class="form-control product-font" style="width:300px" placeholder="J.D"><br>

            <span><h4 class="product-font">Product Image:</h4></span>
        ...
        <div class="col-lg-3 col-md-3" >
            <span><h4 class="product-font" style="margin-top: 80px">Product Brand:</h4></span>
           <select class="form-control product-font">
            ...
            <span><h4 class="product-font" style="margin-top: 80px">Product Branch in Brand:</h4></span>
            <select class="form-control product-font">
